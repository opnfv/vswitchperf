...
class XenaJSON(object):
    ...
    def set_header_vxlan(self, vni=0, **kwargs):
        ...
        self.packet_data['vxlan'] = [
            VXLAN(vni=vni, **kwargs), VXLAN(vni=vni, **kwargs)]
    ...
    def set_header_vxlan_layer3(self, src_ip='192.168.0.2',
                                dst_ip='192.168.0.3', protocol='UDP', **kwargs):
        """
    ...
    def set_header_geneve(self, vni=0, **kwargs):
        """
        Build a geneve scapy object inside instance packet_data structure
        :param vni: The geneve ID
        :param kwargs: Extra params per scapy usage
        :return: None
        """
    ...
    def set_header_geneve_layer3(self, src_ip='192.168.0.2',
                                 dst_ip='192.168.0.3',
                                 protocol='UDP', **kwargs):
        """
        Build scapy IPV4 L3 objects nside instance packet_data structure
    ...
    def set_header_gre(self, **kwargs):
        """
        Build a gre scapy object inside instance packet_data structure
        :param kwargs: Extra params per scapy usage
        :return: None
        """
