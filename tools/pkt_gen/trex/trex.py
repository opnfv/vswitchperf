...
class Trex(ITrafficGenerator):
    ...
    def create_streams(base_pkt_a, base_pkt_b, traffic):
        ...
        if settings.getValue('TRAFFICGEN_TREX_LATENCY_ENABLED'):
    ...
    def generate_traffic(self, traffic, duration):
        ...
        stream_1, stream_2 = Trex.create_streams(packet_1, packet_2, traffic)
    ...
    def calculate_results(stats):
        ...
        result[ResultsConstants.THROUGHPUT_RX_MBPS] = 'Unknown'
        ...
        # Latency statistics are affecting Trex perfomence so they are disabled by default
        if settings.getValue('TRAFFICGEN_TREX_LATENCY_ENABLED'):
