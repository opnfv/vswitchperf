...
# Optional: Parameters specific to RFC2544 Latency test.
...
def main():
    ...
    optionalnamed.add_argument("--test_session_name",
                               required=False,
                               default="RFC2544 East-West Latency",
    ...
    try:
        ...
        # Create the RFC 2544 Latency test
        if args.verbose:
            print ("Set up the RFC2544 Latency test...")
        ...
        resultsdict = (
            stc.perform("QueryResult",
                        params={
                            ...
                            resultsdb,
                            "ResultPath":
                            "RFC2544LatencyTestResultDetailedSummaryView"}))
        if args.verbose:
