...
# Optional: Parameters specific to RFC2544 BackToBack test.
...
def main():
    ...
    optionalnamed.add_argument("--test_session_name",
                               required=False,
                               default="RFC2544 East-West BackToBack",
    ...
    try:
        ...
        # Create the RFC 2544 BackToBack test
        if args.verbose:
            print ("Set up the RFC2544 BackToBack test...")
        ...
        resultsdict = (
            stc.perform("QueryResult",
                        params={
                            ...
                            resultsdb,
                            "ResultPath":
                            "RFC2544BackToBackTestResultDetailedSummaryView"}))
        if args.verbose:
