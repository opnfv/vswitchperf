...
logger = logging.getLogger("stc.log")
...
def create_dir(path):
    if not os.path.exists(path):
        try:
            ...
            logger.debug("Failed to create directory %s: %s", path, str(e))
            raise
...
# Optional: Parameters specific to RFC2544 Throughput test.
...
def main():
    ...
    optionalnamed.add_argument("--metric",
                               required=False,
    ...
    try:
        ...
        logger.debug("The test has completed... Saving results...")
