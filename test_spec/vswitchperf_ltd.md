...
###2.3. Test identification
  ...
  **Expected Result**:
  At the end of each trial, the presence or absence of loss determines the modification of offered load for the next trial, converging on a maximum rate, or [RFC2544] Throughput with zero loss. The Throughput load is re-used in related [RFC2544] tests and other tests.
