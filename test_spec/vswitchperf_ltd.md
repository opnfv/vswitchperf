...
<br/>
  ...
  Characterizing virtual switches (i.e. Device Under Test (DUT) in this document) includes measuring the following performance metrics:
   ...
   - Packet delay introduced by the DUT and its cumulative effect on E2E networks. Frame delay variation can be measured equivalently.
...
[RFC1242]:(http://www.ietf.org/rfc/rfc1242.txt)(http://www.ietf.org/rfc/rfc1242.txt)