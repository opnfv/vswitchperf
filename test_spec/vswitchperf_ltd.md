...
<br/>
  ...
  **Description**:
  ...
  The suggested overload condition would be to transmit traffic at a very high frame rate to the DUT, for at least 60 seconds, then reduce the frame rate to the DUT by half; Record the time-stamp at which the frame rate was halved and record a second timestamp at the time of the last frame lost. The recovery time is the difference between the two timestamps.
