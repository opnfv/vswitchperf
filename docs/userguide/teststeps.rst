...
In general, test scenario is defined by a ``deployment`` used in the test case
definition. Chosen deployment scenario will take care about vSwitch configuration,
deployment of VNFs and it can also affect configuration of a traffic generator.
In order to allow a more flexible way of testcase scripting, VSPERF supports
...
Example of modification of a standard deployment scenario with additional TestSteps.
