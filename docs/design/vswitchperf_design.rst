...
.. code-block:: python
    ...
    class ITrafficGenerator:
      ...
      send_rfc2544_throughput(traffic, tests, trials, duration, lossrate)
      start_rfc2544_throughput(traffic, tests, trials, duration, lossrate)
      wait_rfc2544_throughput(self)

      send_rfc2544_back2back(traffic, tests, trials, duration, lossrate)
      start_rfc2544_back2back(traffic, , tests, trials, duration, lossrate)
