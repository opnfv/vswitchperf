...
The vswitchperf could be downloaded from its official git repository, which is
...
Previous command will create a directory ``vswitchperf`` with a local copy of vswitchperf
repository.
