...
threshold, as benchmarks do not (should not do this). The results/metrics for a
test are simply reported. If it had to be defined, a test is considered to have
passed if it succesfully completed and a relavent metric was recorded/reported
for the SUT.
...
Interfaces among the parties involved
======================================
