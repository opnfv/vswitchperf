...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    **Description**:
    ...
    Each test case requires selection of a specific match action(s),
    a percentage of total traffic that is elligible for the match
    action, determination of the specific test configuration (number
    of flows, number of test ports, whether an external controller
    is used or not, and measurement of the RFC 2544 Throughput level
    with X% packet loss. Traffic shall be bi-directional and symmetric. 
